...
export function TourBookingSection({ dictionary, tour, lang, hotels, meetingPoints }: TourBookingSectionProps) {
    ...
    const Step1 = (
        ...
        >
            ...
            <Button size="lg" className="w-full font-bold text-lg py-7 bg-secondary text-white hover:bg-secondary/80" onClick={() => setStep(step + 1)} disabled={!date}>
    ...
    const Step2 = (
        ...
        >
            ...
            <div className="space-y-3">
                 <Button size="lg" className="w-full font-bold text-lg py-7 bg-secondary text-white hover:bg-secondary/80" onClick={handleContinueToPayment} disabled={!selectedHotel || !suggestedMeetingPoint || !customerName || !customerEmail || !customerPhone}>
                ...
                <div className="flex items-center justify-between gap-4">
                    ...
                    <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
                        <SheetTrigger asChild>
                            <Button size="lg" className="font-bold text-lg flex-grow bg-secondary text-white hover:bg-secondary/80">
