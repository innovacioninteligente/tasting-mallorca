                        ...
                        <div className="mt-12 flex flex-col sm:flex-row items-center gap-6">
                            ...
                            <div className="flex items-center">
                                <div className="flex -space-x-4">
                                    ...
                                    {testimonialAvatar2 && <Image className="inline-block h-12 w-12 rounded-full ring-2 ring-background" src={testimonialAvatar2.imageUrl} alt="User 2" data-ai-hint={testimonialAvatar2.imageHint} width={48} height={48} unoptimized />}
