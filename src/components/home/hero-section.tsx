      ...
      <div className="container relative">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button asChild size="lg" variant="outline" className="font-bold text-base rounded-full px-8 py-7 w-full sm:w-auto bg-white/10 border-white/50 text-white hover:bg-white/20">
