...
export function GuideRouteGuard({ children }: { children: React.ReactNode }) {
            ...
            <Card className="max-w-md w-full text-center">
                ...
                <CardContent>
                    <p className="text-muted-foreground mb-6">
                        You do not have the necessary permissions to access this page. This area is for guides and administrators only.
                    </p>
                    <Button asChild>
