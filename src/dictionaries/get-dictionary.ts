...
const dictionaries = {
  en: {
    ...
    cookieSettings: () => import('./en/cookie-settings.json').then((module) => module.default),
  ...
  fr: {
    ...
    footer: () => import('./fr/footer.json').then((module) => module.default),
    ...
    cookieSettings: () => import('./fr/cookie-settings.json').then((module) => module.default),
  ...
  de: {
    ...
    footer: () => import('./de/footer.json').then((module) => module.default),
    ...
    cookieSettings: () => import('./de/cookie-settings.json').then((module) => module.default),
  ...
  nl: {
    ...
    footer: () => import('./nl/footer.json').then((module) => module.default),
    ...
    cookieSettings: () => import('./nl/cookie-settings.json').then((module) => module.default),
...
const loadDictionary = async (locale: Locale) => {
    ...
    return {
        ...
        cookieSettings: await lang.cookieSettings(),
