...
export async function generateMetadata({ params: { lang } }: PageProps): Promise<Metadata> {
    ...
    const pageTitle = dictionary.header.about;
    const pageDescription = "Learn more about Tasting Mallorca's philosophy, values, and commitment to authentic, sustainable tourism.";
