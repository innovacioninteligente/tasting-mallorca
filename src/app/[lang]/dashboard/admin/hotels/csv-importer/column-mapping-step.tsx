...
import { importHotelsFromCsv } from '@/app/server-actions/hotels/importHotelsFromCsv';
...
const hotelFields = [
    { value: 'name', label: 'Nombre del Hotel' },
    { value: 'address', label: 'Dirección' },
    { value: 'region', label: 'Región' },
    { value: 'subRegion', label: 'Sub-Región' },
...
export function ColumnMappingStep({ file, headers, data, onBack, setSheetOpen }: ColumnMappingStepProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const result = await importHotelsFromCsv({
            ...
            toast({
                ...
                description: `${result.data?.importedCount} hoteles han sido importados.`,
            });
            router.refresh();
            setSheetOpen(false);
