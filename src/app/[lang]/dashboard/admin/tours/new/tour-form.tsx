                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-6">
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>Promotional Video - English (Optional)</FormLabel>
                                        <FormControl>
                                            <VideoUpload
                                                value={field.value}
                                                onChange={field.onChange}
                                                onServerVideoDelete={onServerImageDelete}
                                            />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                ...
                                render={({ field }) => (
                                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                                        <div className="space-y-0.5">
                                            ...
                                            <FormDescription>Enable special pricing/discount for this tour.</FormDescription>
                                        </div>
                                        <FormControl><Switch checked={field.value} onCheckedChange={field.onChange} /></FormControl>
                                    </FormItem>
                                )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl><Input type="number" min="0" max="100" placeholder="e.g., 15" {...field} /></FormControl>
                                            <FormDescription>The percentage to deduct from the base price.</FormDescription>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                />
                            ...
                            <Tabs defaultValue="de" className="w-full">
                                ...
                                {langTabs.map(lang => (
                                    <TabsContent key={lang.code} value={lang.code} className="mt-4 space-y-6">
                                        ...
                                        <Card className="bg-secondary/50">
                                            <CardHeader><CardTitle className="text-lg">Media ({lang.code.toUpperCase()})</CardTitle></CardHeader>
                                            <CardContent>
                                                <FormField
                                                    control={form.control}
                                                    name={`video.${lang.code as 'de' | 'fr' | 'nl'}`}
                                                    render={({ field }) => (
                                                        <FormItem>
